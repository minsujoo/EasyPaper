...
12. **개인화 Scholar 피드** — OpenAlex와 Semantic Scholar의 검증된 레코드를 바탕으로 보관함·폴더·북마크·관심 평가에 맞는 논문을 추천합니다. 최신·놓친 논문·취향 학습 피드, 유사 논문, BibTeX, 관련성 점수, 24시간 정기 수집과 라이브러리 직접 저장을 지원합니다.
