// 프로젝트 전역에서 쓰이는 심플한 라인 아이콘 모음 (Feather 스타일, 의존성 없이 인라인 SVG로 직접 정의)
// 기존 index.html 안에 손으로 심어둔 아이콘들과 동일한 컨벤션을 따른다:
...
const PATHS = {
  ...
  tag: '<path d="M20.59 13.41L13.42 20.58a2 2 0 0 1-2.83 0L2.59 12.58a2 2 0 0 1 0-2.83l7.17-7.17a2 2 0 0 1 1.41-.58H19a2 2 0 0 1 2 2v6.59a2 2 0 0 1-.59 1.41z"/><line x1="7" y1="7" x2="7.01" y2="7"/>',
